...
const zh = {
    ...
    account: {
      ...
      myComments: '我评论过的',
      supportTip: '赞赏 · 支持维护',
      supportTipHint: '自愿支持维护 · 爱发电',
    },
    tip: {
      title: '赞赏 · 支持维护',
      subtitleAfdian: '下列金额与爱发电赞助方案一致（CNY）；支持微信 / 支付宝。',
      subtitleStripe: '下列金额与 Stripe 收银台一致（HKD）。',
      subtitleCreem: '下列金额为参考价；实际以 Creem 收银台为准（USD）。',
      stripeTest: 'Stripe 测试模式 · 不会真实扣款',
      creemTest: 'Creem 测试模式 · 不会真实扣款',
      stripeFrameTitle: 'Stripe 安全收银台',
      creemFrameTitle: 'Creem 安全收银台',
      afdianFrameTitle: '爱发电赞助页',
      tierHintAfdian: '选择档位将在新窗口打开爱发电；可选只赞助 1 个月，金额以收银台为准。',
      tierHintStripe: '选择档位后进入 Stripe 收银台；请确认金额与所选档位一致。',
      tierHintCreem: '选择档位将在新窗口打开 Creem 收银台；请确认金额后完成支付。',
      footer: '自愿支持，感谢每一份心意。',
      backToTiers: '换一档',
      openInNewTab: '新窗口支付',
    },
...
const en = {
    ...
    account: {
      ...
      supportTipHint: 'Optional support · Afdian',
    },
    tip: {
      title: 'Tip · Support the project',
      subtitleAfdian: 'Amounts match Afdian tiers (CNY); WeChat Pay / Alipay accepted.',
      subtitleStripe: 'Amounts match Stripe checkout (HKD).',
      subtitleCreem: 'Amounts are indicative; Creem checkout shows the final price (USD).',
      stripeTest: 'Stripe test mode — no real charges',
      creemTest: 'Creem test mode — no real charges',
      stripeFrameTitle: 'Stripe secure checkout',
      creemFrameTitle: 'Creem secure checkout',
      afdianFrameTitle: 'Afdian checkout',
      tierHintAfdian: 'Opens Afdian in a new tab — you can sponsor for 1 month only; confirm the amount at checkout.',
      tierHintStripe: 'Pick a tier, then confirm the matching amount at Stripe checkout.',
      tierHintCreem: 'Opens Creem checkout in a new tab — confirm the amount before paying.',
