...
const zh = {
    ...
    account: {
      ...
      myComments: '我评论过的',
      supportTip: '赞赏 · 支持维护',
      supportTipHint: '自愿支持服务器与地图维护，站内完成支付',
      supportTipTest: '当前为支付测试模式，不会真实扣款',
    },
    tip: {
      title: '赞赏 · 支持维护',
      subtitle: '地图与服务器维护靠自愿支持，金额随意，感谢每一份心意。',
      customLabel: '闷声发大财 · 自定义金额',
      customHint: '支持 ¥1 起（按 $1/份折算），支付宝 / 微信 / 银行卡均可',
      usdNote: 'BagelPay 以 USD 结算，金额以收银台为准',
      pay: '去支付',
      loading: '正在打开收银台…',
      checkoutError: '暂时无法创建支付，请稍后再试',
      invalidAmount: '请输入至少 ¥0.01',
      invalidAmountCustom: '自定义金额请至少 ¥1',
      amountTooLarge: '单笔请勿超过 ¥9999',
      backToTiers: '换一档',
      openInNewTab: '新窗口支付',
      iframeBlocked: '收银台无法嵌入，请在新窗口完成支付',
      checkoutFrameTitle: 'BagelPay 安全收银台',
      fallbackOpened: '已在新窗口打开支付页（API 未配置时的备用方式）',
    },
    editorLogin: {
      title: '登录以贡献内容',
...
const en = {
    ...
    account: {
      ...
      supportTipHint: 'Optional support for hosting — pay in this dialog',
      supportTipTest: 'Payment test mode — no real charges',
    },
    tip: {
      title: 'Tip · Support the project',
      subtitle: 'Voluntary support for hosting and maintenance. Every bit helps.',
      customLabel: 'Custom amount (CNY)',
      customHint: 'From ¥1 · Alipay, WeChat Pay, cards accepted',
      usdNote: 'Charged in USD at checkout',
      pay: 'Pay',
      loading: 'Opening checkout…',
      checkoutError: 'Could not start checkout. Please try again.',
      invalidAmount: 'Enter at least ¥0.01',
      invalidAmountCustom: 'Custom amount: at least ¥1',
      amountTooLarge: 'Maximum ¥9999 per tip',
      backToTiers: 'Choose another tier',
      openInNewTab: 'Open in new tab',
      iframeBlocked: 'Checkout cannot embed here — open in a new tab',
      checkoutFrameTitle: 'Secure checkout',
      fallbackOpened: 'Opened checkout in a new tab (API fallback)',
    },
    editorLogin: {
