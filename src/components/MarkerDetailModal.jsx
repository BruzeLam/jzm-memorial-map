      ...
      <MemorialModal onClose={onClose} panelClassName="max-w-2xl mobile-detail-panel pb-safe">
        ...
        >
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <h2 className="text-lg md:text-xl font-bold font-memorial text-memorial-navy truncate">
                {marker.name}
              </h2>
              <span
        ...
        <div className="flex-1 overflow-y-auto overscroll-contain px-4 md:px-6 py-4">
          {marker.tags?.length > 0 && (
            <MarkerTagPills tags={marker.tags} onTagClick={onTagSearch} className="mb-3" />
          )}
