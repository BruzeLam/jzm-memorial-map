        ...
        <div className="relative flex-1 min-w-0">
          <span
            className={`absolute left-3 top-1/2 -translate-y-1/2 ${
              isAgent ? 'text-violet-400' : 'text-memorial-muted'
          ...
          <input
            ...
            className={`w-full pl-9 memorial-input ${
          ...
          {!isAgent && searchQuery && (
            <button
              type="button"
              onClick={clearSearch}
              className="absolute right-3 top-1/2 -translate-y-1/2 text-memorial-muted hover:text-memorial-ink text-xs"
      ...
      {isAgent && hasAgentMessages && (
        <div className="flex justify-end">
          <button
            ...
            className="text-[10px] text-memorial-muted hover:text-memorial-ink"
          >
            {t('agent.clear')}
          </button>
        </div>
